...
namespace 贴标机改 //命名空间根据应用程序修改
{
    public partial class LTDMC
    {
        public static class state_axis
        {
            public const int state_alm = 0x001;  //0正限位
            public const int state_elp = 0x002;  //1正限位
            public const int state_eln = 0x004;  //2负限位
            public const int state_emg = 0x008;  //3急停
            public const int state_org = 0x010;  //4原点
            public const int state_slp = 0x040;  //6正限位
            public const int state_sln = 0x080;  //7负限位
            public const int state_inp = 0x100;  //8INP
            public const int state_rdy = 0x400;  //10RDY
            public const int alarm_elp = state_elp + state_slp;  //正限位
            public const int alarm_eln = state_eln + state_sln;  //负限位
        }
